...
!function (c) {
    if ('undefined' != typeof window) {
        var i = !0, o = 10, r = '', a = 0, u = '', s = null, d = '', l = !1, f = {resize: 1, click: 1}, m = 128, h = !0,
            g = 1, n = 'bodyOffset', p = n, v = !0, y = '', w = {}, b = 32, T = null, E = !1, O = !1,
            S = '[iFrameSizer]', M = S.length, I = '', N = {max: 1, min: 1, bodyScroll: 1, documentElementScroll: 1},
            A = 'child', C = !0, z = window.parent, k = '*', R = 0, x = !1, e = null, L = 16, F = 1, t = 'scroll',
            P = t, D = window, j = function () {
    ...
    function de(e) {
        ...
        }), se({method: e, eventType: 'Print', eventNames: ['afterprint', 'beforeprint']}), se({
            method: e,
